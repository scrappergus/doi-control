Meteor.methods({
  generate_xml_from_json: function(journal_name, journal_json) {
    ...
    var batch_id = DOIBatches.insert({
      crossref_data: crossref_json
    });
    ...
    for (var i = 0; i < json_data.articles.length; i++) {
      ...
      var new_article_element = {
        ...
        publication_date: (function() {
          ...
          if (current_article_data.date_published && current_article_data.date_published != "")
            usedate = current_article_data.date_published;
          return generate_publication_date(usedate);
        })(),
        pages: (function() {
          if (current_article_data.first_page == void 0 || current_article_data.first_page == "") return null;
          var pgs = {};
          if (current_article_data.first_page != void 0)
            pgs['first_page'] = current_article_data.first_page;
          if (current_article_data.last_page != void 0)
            pgs['last_page'] = current_article_data.last_page;
          return pgs;
        })(),
        publisher_item: {
          identifier: {
      ...
      for (var key in new_article_element) {
        if (new_article_element[key] == null)
          delete new_article_element[key];
      }
